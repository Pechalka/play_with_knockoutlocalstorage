define([
    ...
    return function(model){
        ...
        self.repeatStorage= ko.observable(false).extend({localStorage:'yor.repeat.transport'});
        ...
        self.visibleCategories = ko.computed(function(){
            ...
            console.log('c');
            return ko.utils.arrayFilter(model.categories(), function(c){ return c.part == 'Transport'; })
        });
