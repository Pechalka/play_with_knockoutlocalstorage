define([
    ...
    return function(model){
        ...
        self.repeatStorage= ko.observable(false).extend({localStorage:'yor.repeat.personal'});
        ...
        self.visibleCategories = ko.computed(function(){
            return ko.utils.arrayFilter(model.categories(), function(c){ return c.part == 'Personal'; })
        });
